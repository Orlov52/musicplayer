...
public class HelloApplication extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        chooseFileButton.setOnAction(event -> {
            ...
            if (selectedFile != null) {
                try {
                    ...
                    mediaPlayer[0].setStartTime(Duration.seconds(startTimeSlider.getValue()));
                    mediaPlayer[0].setStopTime(Duration.seconds(endTimeSlider.getValue()));
        ...
        VBox root = new VBox(10, volumeSlider, timeSlider, startTimeSlider, endTimeSlider, startTimeLabel, endTimeLabel, playButton, chooseFileButton);
